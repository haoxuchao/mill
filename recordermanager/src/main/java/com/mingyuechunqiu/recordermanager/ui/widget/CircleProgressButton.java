...
public class CircleProgressButton extends View {
    ...
    private final int DEFAULT_IDLE_CIRCLE_COLOR = getResources().getColor(android.R.color.holo_blue_dark);
    private final int DEFAULT_PRESSED_CIRCLE_COLOR = getResources().getColor(android.R.color.holo_blue_bright);
    ...
    private final int DEFAULT_PROGRESS_DURATION = 30;
