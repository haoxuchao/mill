...
public interface RecordVideoContract {
    ...
    abstract class Presenter<V extends View<?>> extends BaseAbstractPresenter<V> {
         ...
         * @param option 配置信息对象
         */
        public abstract void initConfiguration(@NonNull RecordVideoOption option);
         ...
         * @param holder 图层控制
         */
        public abstract void startPreview(@Nullable SurfaceHolder holder);
         ...
         */
        public abstract boolean pressToStartRecordVideo(@Nullable SurfaceHolder holder, @NonNull AppCompatImageView ivFlipCamera,
                                                 @NonNull AppCompatImageView ivFlashlight, @NonNull AppCompatImageView xcimg);
         ...
         */
        public   abstract void releaseToStopRecordVideo(boolean isCancel);
         ...
         * @param holder 图层控制
         */
        public  abstract void flipCamera(@Nullable SurfaceHolder holder);
         ...
         */
        public abstract boolean stopRecordVideo();

        /**
         * 释放计时资源
         */
        public  abstract void releaseTiming();
         ...
         * @param ivPlay       播放控件
         */
        public abstract void pausePlayVideo(boolean controlViews, @NonNull AppCompatImageView ivPlay);
         ...
         * @param holder       图层控制
         */
        public abstract void resumePlayVideo(boolean controlViews, @NonNull AppCompatImageView ivPlay, @Nullable SurfaceHolder holder);
         ...
         * @param holder 图层控制
         */
        public abstract void controlPlayOrPauseVideo(@NonNull AppCompatImageView ivPlay, @Nullable SurfaceHolder holder);
         ...
         * @param ivPlay 播放控件
         */
        public abstract void onSurfaceCreated(@NonNull SurfaceHolder holder, @NonNull AppCompatImageView ivPlay);
         ...
         */
        @NonNull
        public  abstract String getTimingHint(@NonNull String timing, boolean isInTiming);
         ...
         */
        public abstract boolean switchFlashlightState(boolean turnOn);
    }
}
