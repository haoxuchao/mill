...
import com.cn.android.ui.activity.ForgetPwdActivity;
...
//        }
                        ...
                        if (mListener != null) {
                            postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (isclear) {
                                        mPasswordView.setPassWordLength(0);
                                        mRecordList.clear();
                                        mTitleView.setText("请确认交易密码");
                                        isclear = false;
                                    }
                                }
                            }, 300);
    ...
    private static final class KeyboardAdapter extends MyRecyclerViewAdapter<String> {
        ...
        public MyRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            switch (viewType) {
                case TYPE_DELETE:
                    return new SimpleHolder(R.layout.item_pay_password_delete);
                case TYPE_EMPTY:
                    return new SimpleHolder(R.layout.item_pay_password_empty);
                default:
